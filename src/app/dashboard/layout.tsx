    ...
    <SidebarProvider>
      <div className="flex min-h-screen bg-background w-full font-body">
        <Sidebar variant="sidebar" className="border-r border-border/40 bg-sidebar-background">
          ...
          <SidebarContent>
            <SidebarGroup>
              <SidebarGroupLabel className="px-6 text-[9px] uppercase tracking-[0.2em] text-muted-foreground/50 mt-6 mb-2">Network Operations</SidebarGroupLabel>
              <SidebarMenu>
                {menuItems.map((item) => (
          ...
          <header className="h-16 flex items-center px-10 border-b border-border/10 glass-panel sticky top-0 z-50">
            ...
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-bold text-primary uppercase tracking-widest">Global Pulse Stream: Active</span>
              </div>
